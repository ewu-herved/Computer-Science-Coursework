...
int main() {
    ...
    pthread_t pro1, pro2, pro3, con1;
	pthread_mutex_init(&the_mutex, 0);
	pthread_cond_init(&condc, 0);
	pthread_cond_init(&condp, 0);
	pthread_create(&pro1, 0, producer, NULL);
    pthread_create(&pro2, 0, producer, NULL);
    pthread_create(&pro3, 0, producer, NULL);
    pthread_create(&con1, 0, consumer, NULL);
