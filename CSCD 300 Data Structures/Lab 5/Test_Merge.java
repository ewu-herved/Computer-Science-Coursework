...
public class Test_Merge {
   ...
   public static void main(String [] args) {      
      ...
      do {
         ...
         try {            
            ...
            int fileNum = args.length; //number of files
            ...
            fileAra = new ArrayQueue[fileNum]; //array of arrayQueues
            ...
            files = new Scanner[fileNum]; //scanner array for files
            
            arrayMaker(fileNum, args); //makes the array appropriate size
   ...
   public static void combine(ArrayQueue[] fileAra, Scanner[] files) {  //gathers info from ArrayQueues into ListQueue
